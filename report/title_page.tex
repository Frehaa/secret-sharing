...
\textsc{\Large Exam Submission}\\[0.5cm] % Major heading such as course name
\textsc{\large Cryptographic Computation and Blockchain}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Interactive Verifiable Secret Sharing}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
